...
export const CarsList = () => {
    ...
    const handleToggleFavorite = (car) => {
        ...
        if (isAlreadyFavorite) {
          ...
          const carToAdd = { ...car, id: nanoid() }; // Додаємо унікальний ідентифікатор
  ...
  address,
                ...
                <button className={css.btnLike} onClick={() => handleToggleFavorite({ id, img, make, model, type, mileage, year, rentalPrice, rentalCompany, functionalities, address })}>
